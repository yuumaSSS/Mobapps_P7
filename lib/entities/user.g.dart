...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> namaIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> namaIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> umurIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'umur',
      ));
  ...
  QueryBuilder<User, User, QAfterFilterCondition> umurIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'umur',
      ));
  ...
  QueryBuilder<User, User, QAfterFilterCondition> umurEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'umur',
        value: value,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> umurGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> umurLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> umurBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQueryLinks on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> kelas(FilterQuery<MK> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'kelas');
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> kelasLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> kelasIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'kelas', 0, true, 0, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> kelasIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'kelas', 0, false, 999999, true);
    });
  }

  QueryBuilder<User, User, QAfterFilterCondition> kelasLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> kelasLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> kelasLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByUmur() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'umur', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByUmurDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByUmur() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'umur', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByUmurDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'umur', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByUmur() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, int?, QQueryOperations> umurProperty() {
    return QueryBuilder.apply(this, (query) {
